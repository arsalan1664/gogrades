  ...
  const footerItems = [
    {
      ...
      itemList: [
        ...
        { name: "Place Order", link: `${reg}/order` },
      ...
      <div className="flex myContainer  py-[40px] justify-between  md:flex-row flex-col gap-7 lg:gap-14">
        <div className="w-full">
          <div className="flex md:flex-row flex-col lg:gap-10  gap-3  w-[100%] justify-between ">
            <div className="w-full md:w-[140px] lg:w-[200px]">
              <Link href={`${reg}/`}>
                <img
                  height={121}
                  width={320}
              ...
              <p className="text-[#fff] text-[15px] mt-5">
                We are the best academic consultancy provider. We have a
                thousands of happy customers from worldwide. Who happy with our
                high-quality service & the all credit goes to our most
                experienced and professional writing team.
              </p>
            </div>
        ...
        <div className="bg-[#101A31] rounded-[10px] p-[12px] lg:p-[28px] h-fit max-md:w-[100%] max-[830px]:w-[230px] max-md:mt-8">
          ...
          <div>
            ...
            <Link
              ...
              href={`https://wa.me/${number.number}?text=Hi, I Need Academic Help Instantly. Could You Please Assist Me In Submitting My Assignment Before The Deadline?`}
              className="text-white text-[18px] flex items-center gap-2"
              target="_blank"
            >
...
function Dropdown(itemm: any) {
  ...
  return (
    <div className="md:hidden flex flex-col my-1 mt-3">
      <h4
        className="w-[100%] flex items-center justify-between text-white text-[18px] pb-2"
        onClick={() => {
          setIsOpen(!open);
        }}
      >
